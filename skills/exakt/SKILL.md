---
name: exakt
description: Use when a user invokes $exakt or /exakt with an engineering task, bug, feature, migration, investigation, product brief, PRD, or full product specification.
---
